...
<head>
    ...
    <title>Pedidos - Cafetín Jesús Obrero</title>
    <link rel="icon" href="imagenes/cj.png" type="image/png"> <!-- Enlace al favicon -->
    @vite(['resources/css/app.css', 'resources/js/app.js','resources/css/empleados.css']) <!-- Asegúrate de tener un archivo CSS -->
...
<body>
    ...
    <center><h2>¡Hola [Nombre del Trabajador]!</h2></center>
    <!-- Interfaz de Pedidos -->
